...
// Fetches an external endpoint, tracking connectivity and mapping low-level
// failures onto our error types. Everything past the fetch (status checks,
// parsing) is left to the caller, since those diverge per endpoint.
